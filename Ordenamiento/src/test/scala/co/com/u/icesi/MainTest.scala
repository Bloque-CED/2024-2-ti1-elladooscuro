...
class MainTest extends AnyFunSuite {
  ...
  //CountingSort , de acuerdo a la descripción del capítulo 8 del texto de Cormen[1]
  //RadixSort , de acuerdo a la descripción del capítulo8 del texto de Cormen[1]
